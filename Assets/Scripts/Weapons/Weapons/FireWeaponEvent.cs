...
{
    public event Action<FireWeaponEvent, FireWeaponEventArgs> OnWeaponFire;

    public void CallOnWeaponFire(bool fire, bool firePreviousFrame, AimDirection aimDirection, float aimAngle,
        float weaponAimAngle, Vector3 weaponAimDirectionVector)
    {
        OnWeaponFire?.Invoke(this, new FireWeaponEventArgs()
        {
            fire = fire,
