...
public class RoomTemplateSO : ScriptableObject
{
    ...
    //populate the list with all enemies that can be spawned in this room by dungeon level.
...
//if UNITY_EDITOR
    ...
    private void OnValidate()
    {
        ...
        HelperUtilities.ValidateCheckEnumerateValues(this, nameof(doorwayList), doorwayList);

        // Check spawn positions populated
        HelperUtilities.ValidateCheckEnumerateValues(this, nameof(spawnPositionArray), spawnPositionArray);
    }
